...
namespace CSharp_Basics
{
    ...
    public class DataTypesAndVariables
    {
        ...
        public void float_double_decimal()
        {
            ...
            Assert.AreEqual(140000000000000000000000000.0010000000000000000000000008, add, "Example Has wrong value did you changed it?");
            Assert.AreEqual(1.4E+26d, subtract, "Wrong value maybe other way around?");
            Assert.AreEqual(1.7500000000000001E+53d, divide, "Example Has wrong value did you changed it?");
            Assert.AreEqual(0.112, multiply, "Wrong value maybe other way around?");
